...
/*客户端编译*/
gcc client/client.c client/mygets.c protocol/filepdu.c -o clt  -I./inc -Wall

/*服务端编译*/
多进程：gcc server/server_mp.c protocol/filepdu.c -o svr -I./inc -Wall
多线程：gcc server/server_mt.c protocol/filepdu.c -o svr -I./inc -Wall -lpthread
多路复用：gcc server/server_select.c protocol/filepdu.c -o svr -I./inc -Wall
